...
<head>
    ...
    <title>Event Participations - Admin</title>
...
<body>
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 class="mb-0"><i class="bi bi-people me-2"></i>Event Participations</h3>
            <div>
                                ...
                                <tbody>
                                    <c:forEach var="p" items="${pendingParticipations}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="small">${p.event.name}</div>
                                                <div class="text-muted small">${p.event.location}</div>
                                            </td>
                                            <td>${p.event.pointValue}</td>
                                            <td>
                                                <form action="${pageContext.request.contextPath}/admin/approve-event-participation/${p.id}" method="post" style="display:inline;">
                                                    <button type="submit" class="btn btn-sm btn-success"><i class="bi bi-check2"></i></button>
                                                </form>
                                                <form action="${pageContext.request.contextPath}/admin/reject-event-participation/${p.id}" method="post" style="display:inline;">
